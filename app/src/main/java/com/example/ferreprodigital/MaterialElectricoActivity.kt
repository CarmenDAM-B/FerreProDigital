...
class MaterialElectricoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupMaterialElectricoRecyclerView()
    }

    private fun setupMaterialElectricoRecyclerView() {
        val products = getMaterialElectricoProducts()
