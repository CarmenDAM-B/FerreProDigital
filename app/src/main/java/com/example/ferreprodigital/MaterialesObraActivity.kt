...
class MaterialesObraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewProducts = findViewById(R.id.recyclerViewProducts) // 🔹 Se reemplaza recyclerView

        setupMaterialesObraRecyclerView()
    }

    private fun setupMaterialesObraRecyclerView() {
        val products = getMaterialesObraProducts()
